...
import (
	...
	controllers11 "github.com/revel/modules/jobs/app/controllers"
	_ "github.com/revel/modules/jobs/app/jobs"
	controllers9 "github.com/revel/modules/pprof/app/controllers"
	controllers12 "github.com/revel/modules/static/app/controllers"
	_ "github.com/revel/modules/testrunner/app"
	controllers10 "github.com/revel/modules/testrunner/app/controllers"
	_ "go-revel-demo/app"
	controllers "go-revel-demo/app/controllers"
	controllers0 "go-revel-demo/app/controllers/Content"
	controllers1 "go-revel-demo/app/controllers/Extend"
	controllers2 "go-revel-demo/app/controllers/Module"
	controllers3 "go-revel-demo/app/controllers/Panel"
	controllers4 "go-revel-demo/app/controllers/Plugin"
	controllers5 "go-revel-demo/app/controllers/Public"
	controllers6 "go-revel-demo/app/controllers/Setting"
	controllers7 "go-revel-demo/app/controllers/Style"
	controllers8 "go-revel-demo/app/controllers/User"
	models "go-revel-demo/app/models"
...
func main() {
	...
	revel.RegisterController((*controllers9.Pprof)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Profile",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers12.Static)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Serve",
				Args: []*revel.MethodArg{ 
	...
	revel.DefaultValidationKeys = map[string]map[int]string{ 
		"go-revel-demo/app/models.(*Admin).Validate": { 
			42: "a.Username",
			43: "a.Username",
			57: "a.Email",
			58: "a.Email",
		...
		"go-revel-demo/app/models.(*Menu).Validate": { 
			32: "menu.Name",
			33: "menu.Name",
			34: "menu.Pid",
			35: "menu.Url",
		...
		"go-revel-demo/app/models.(*Password).ValidatePassword": { 
			78: "P.Password",
